...
rule SRAass:
    ...
    params : script = "workflow/scripts/SRAnsack_ass.py", scratch = params['scratch'], len_cutoff= params['ass_len_cutoff'], max_redundance = params['max_redundance'], min_completeness = params['min_completeness'], rarefaction = params['rarefaction_read_collection'], retries = params['retries']
    threads : 24
